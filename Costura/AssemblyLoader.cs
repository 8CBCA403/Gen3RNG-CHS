...
internal static class AssemblyLoader
{
	...
	static AssemblyLoader()
	{
		...
		assemblyNames.Add("pokemon3genrnglibrary", "costura.pokemon3genrnglibrary.dll.compressed");
		assemblyNames.Add("pokemon3genrnglibrary.frontier", "costura.pokemon3genrnglibrary.frontier.dll.compressed");
		assemblyNames.Add("pokemonprng", "costura.pokemonprng.dll.compressed");
		assemblyNames.Add("pokemonstandardlibrary", "costura.pokemonstandardlibrary.dll.compressed");
		assemblyNames.Add("pokemonstandardlibrary.gen3", "costura.pokemonstandardlibrary.gen3.dll.compressed");
