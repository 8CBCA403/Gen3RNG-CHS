...
internal class StationaryBinder
{
	...
	public StationaryBinder(uint initSeed, uint frame, uint targetFrame, string method, RNGResult<Pokemon.Individual, uint> result, uint tsv)
	{
